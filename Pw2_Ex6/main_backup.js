...
const leftWallLight = new THREE.RectAreaLight(0xff0000, 3, 8, 10);
leftWallLight.position.set(-5.999, 0, 4);
leftWallLight.lookAt(0, 0, 4);
const rightWallLight = new THREE.RectAreaLight(0x00ff00, 3, 8, 10);
rightWallLight.position.set(5.99, 0, 4);
rightWallLight.lookAt(0, 0, 4);
...
shadowFolder.add(obj, "shadowCamera").name("Enable").onChange((value) => {
    if (additionalLight && additionalLight.type !== 'HemisphereLight') {additionalLight.castShadow = value;}
    pointLight.castShadow = value;
})
shadowFolder.add(obj, 'widthShadow', 256, 1024).onChange(value => {
    if (additionalLight && additionalLight.type !== 'HemisphereLight') {additionalLight.shadow.mapSize.width = value;}
    pointLight.shadow.mapSize.width = value;
});
shadowFolder.add(obj, 'heightShadow', 256, 1024).onChange(value => {
    if (additionalLight && additionalLight.type !== 'HemisphereLight') {additionalLight.shadow.mapSize.height = value;}
    pointLight.shadow.mapSize.height = value;
});
shadowFolder.add(obj, 'nearShadow', 0.1, 50).onChange(value => {
    if (additionalLight && additionalLight.type !== 'HemisphereLight') {
        additionalLight.shadow.camera.near = value;
        additionalLight.shadow.camera.updateProjectionMatrix();
    }
    pointLight.shadow.camera.near = value;
    pointLight.shadow.camera.updateProjectionMatrix();
});
shadowFolder.add(obj, 'farShadow', 0.1, 1000).onChange(value => {
    if (additionalLight && additionalLight.type !== 'HemisphereLight') {
        additionalLight.shadow.camera.far = value;
        additionalLight.shadow.camera.updateProjectionMatrix();
    }
...
leftBoardMesh.receiveShadow = true;
...
rightBoardMesh.receiveShadow = true;
...
topBoardMesh.receiveShadow = true;
